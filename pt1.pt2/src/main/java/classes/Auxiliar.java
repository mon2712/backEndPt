...
//Creación deJsons
	...
	public String crearJsonRegistro(String id, String nombre, String nivel, String grado, int time, int cal1, int cal2, int cal3, int cal4,int cal5, int cal6,int cal7, int cal8, int cal9, int cal10){
		StringWriter swriter = new StringWriter();
		//String alumno[], testInicial[], desempeñoGral[], puntajeNivel[];
            try (JsonGenerator gen = Json.createGenerator(swriter)) {
            	gen.writeStartObject();
                gen.writeStartObject("resultsRegistro");
	                ...
	                gen.writeStartObject("infoStudent");
		                ...
		                gen.write("grade",  grado);
		                gen.write("name", nombre);
		                gen.write("idStudent", id);
		                gen.write("startDate", "2017-03-02");
		            gen.writeEnd();
		            gen.writeStartArray("calificaciones");
			            gen.writeStartObject();
			            	 gen.write("hoja","1");
			                 gen.write("calif", cal1);
			             gen.writeEnd();
			             gen.writeStartObject();
			            	 gen.write("hoja","2");
			                 gen.write("calif", cal2);
			             gen.writeEnd();
			             gen.writeStartObject();
			            	 gen.write("hoja","3");
			                 gen.write("calif", cal3);
		                 gen.writeEnd();
				         gen.writeStartObject();
			            	 gen.write("hoja","4");
			                 gen.write("calif", cal4);
			             gen.writeEnd();
			             gen.writeStartObject();
			            	 gen.write("hoja","5");
			                 gen.write("calif", cal5);
			             gen.writeEnd();
			             gen.writeStartObject();
			            	 gen.write("hoja","6");
			                 gen.write("calif", cal6);
		                 gen.writeEnd();
			             gen.writeStartObject();
			            	 gen.write("hoja","7");
			                 gen.write("calif", cal7);
		                 gen.writeEnd();
				         gen.writeStartObject();
			            	 gen.write("hoja","8");
			                 gen.write("calif", cal8);
			             gen.writeEnd();
			             gen.writeStartObject();
			            	 gen.write("hoja","9");
			                 gen.write("calif", cal9);
			             gen.writeEnd();
			             gen.writeStartObject();
			            	 gen.write("hoja","10");
			                 gen.write("calif", cal10);
		                 gen.writeEnd();
		            gen.writeEnd();
                gen.writeEnd();
                gen.writeEnd();
